...
async function prepareInputStream(inputChunksQuads, inputStreamMode) {
  const chunks = inputStreamMode === 'quad stream' ? inputChunksQuads.flat() : inputChunksQuads
  return Readable.from(chunks)
}

async function run (operationQuads, inputStream, parametersQuads, overwriteParams) {
